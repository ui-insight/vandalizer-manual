...
![](images/tasks.png){width="100%" style="cursor: pointer;" onclick="document.getElementById('lightbox').style.display='block'"}
...
In the toolbox window, users can create tasks by clicking on the **Chat** tab at the top of the window. From there, users can either click on 
  <span style="color: #2c7eaabc;">{{< fa diagram-project >}}</span> **Run a task** or on the <div style="border: 2px solid #ccc; padding: 4px; display: inline-block;">{{< fa diagram-project >}} **TASKS**</div> button
