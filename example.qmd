...
Vandalizer will immediately begin analyzing the document with its Optical Character Recognition (OCR) process, indicated by the spinner icon in the corner. Wait for this process to complete—when you see the {{< fa code >}} icon, Vandalizer has successfully extracted all the text and is ready for the next step.
...
Now click on the ![Add your first task](images/buttons/add-first-task-btn.png){height="30px"} button, click **Prompts**, and select your previously created prompt task. Repeat these steps to add the other 5 prompt tasks (In the same step).
